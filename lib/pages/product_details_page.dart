...
import 'package:user_app/models/comment_model.dart';
import 'package:user_app/pages/ar_vr_page.dart';
...
import 'package:user_app/utils/helper_functions.dart';
import 'package:user_app/utils/widget_functions.dart';
                    ...
                    onPressed: () async {
                      ...
                      if (AuthService.currentUser!.isAnonymous) {
                        ...
                        final notification = NotificationModel(
                          ...
                          message:
                              'A new comment on ${productModel.productName} is waiting for your approval',
